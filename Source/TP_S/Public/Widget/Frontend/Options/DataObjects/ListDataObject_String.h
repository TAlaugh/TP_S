...
UCLASS()
class TP_S_API UListDataObject_StringBool : public UListDataObject_String
{
	GENERATED_BODY()
...
UCLASS()
class TP_S_API UListDataObject_StringEnum : public UListDataObject_String
{
	GENERATED_BODY()
...
UCLASS()
class TP_S_API UListDataObject_StringInteger : public UListDataObject_String
{
	GENERATED_BODY()
